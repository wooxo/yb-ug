...
To perform a backup using VMware vSphere:

* A paid license is required in order to be able to use VMware API for backups
* Make sure the VMware ESX version is compatible with version 6.0 and above.
...
* Associate a single virtual machine with a backup job if you want to enable OneClick Restart
{% endtab %}
{% endtabs %}
